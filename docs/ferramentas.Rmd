...
`r applause::button(color="#1aa6b4", style="float:right;", multiclap = FALSE)` Nesta página estão descritas os softwares, pacotes e ferramentas que utilizei para a criação deste site.
...
-  `r emo::ji("woman_technologist")` + `r emo::ji("purple_heart")`+ `r emo::ji("hot_beverage")`!
