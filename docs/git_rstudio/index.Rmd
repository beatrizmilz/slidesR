...
- No terminal (Substitua pelo seu nome e email):
...
## Método 3 - Trabalho colaborativo
...
---
ESCREVER AQUI.
O MAIS COMO É QUE O PR NAO SEJA ACEITO DE PRIMEIRA.
ENTÃO....... MOSTRAR COMO ARRUMAR!
...
- criar com NEW PROJECT FROM GIT REPO

- se apresentar, é melhor via terminal
.

- fazer as mudanças, stage, commit. Push - vai pedir o usuario. depois já funciona
