...
## Beatriz Milz      
[`r icons::icon_style(icons::fontawesome(name = "question", style = "solid"), fill = "#88398a", scale = 1.7)`](https://discourse.curso-r.com/u/beatrizmilz/summary) 
[`r icons::icon_style(icons::fontawesome(name = "home", style = "solid"), fill = "#88398a", scale = 1.7)`](https://beatrizmilz.com/)
[`r icons::icon_style(icons::fontawesome("twitter"), fill = "#88398a", scale = 2)`](https://twitter.com/BeaMilz)
[`r icons::icon_style(icons::fontawesome(name = "github"), fill = "#88398a", scale = 2)`](https://github.com/beatrizmilz)
[`r icons::icon_style(icons::academicons("orcid"), fill = "#88398a", scale = 2)`](https://orcid.org/0000-0002-3064-4486)
[`r icons::icon_style(icons::academicons("lattes"), fill = "#88398a", scale = 2)`](http://lattes.cnpq.br/5150665880581477)
...
- `r emo::ji("white_large_square")` Adicionar o GitHub Token/PAT no arquivo `.Renviron` 
