...
**[Beatriz Milz](https://beatrizmilz.com)** <a href='mailto:beatriz.milz@usp.br'><i class="far fa-envelope"></i></a>  <a href='https://twitter.com/BeaMilz'><i class="fab fa-twitter"></i>   <a href='https://github.com/beatrizmilz'><i class="fab fa-github"></i>
...
Exemplo: Base de dados `diamante` disponível no pacote [`dados`](https://cienciadedatos.github.io/dados/).
...
```{r}
diamante[1, 2] # Seleciona a linha 1 e a coluna 2 
```
...
```{r}
diamante[1, ] # Seleciona a linha 1 e TODAS as colunas
```

```{r}
diamante[ , 1] # Seleciona TODAS as linhas e apenas a coluna 1
```
...
```{r}
# Soma do valor de TODOS os diamantes que estão na tabela
sum(diamante$preco) 
# Menor preço encontrado: o diamante mais barato !
min(diamante$preco)
# Maior preço encontrado: o diamante mais caro !
max(diamante$preco)
```
...
```{r}
# Média dos preço dos diamantes
mean(diamante$preco)
# Mediana dos preço dos diamantes
median(diamante$preco)
# Variância dos preço dos diamantes
var(diamante$preco)
# Desvio padrão dos preço dos diamantes
sd(diamante$preco)
```
...
## Em Português
- Material da Curso-R: http://material.curso-r.com/rbase/
...
<center>
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdGDGM80RJloUQXvX5N6kl2bFJSn60cpPcM_JR4AnNe9-tvgQ/viewform" height="100%" width="100%" style="min-height: 600px;"></iframe>
</center>
